//! 对应 Java `me.chanjar.weixin.open.bean.icp.WxOpenSubmitAuthAndIcpParam.java`。
//!
...
use super::*;
#[allow(unused_imports)]
use crate::bean::auth::MaAuthSubmitParamAuthData;
...
pub struct WxOpenSubmitAuthAndIcpParam {
    ...
    pub auth_data: MaAuthSubmitParamAuthData,
}
