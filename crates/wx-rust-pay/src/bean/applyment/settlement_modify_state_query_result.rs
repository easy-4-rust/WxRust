//! 对应 Java `com.github.binarywang.wxpay.bean.applyment.SettlementModifyStateQueryResult.java`。
//!
...
pub struct SettlementModifyStateQueryResult {
    #[serde(
        default,
    ...
    #[serde(default, rename = "verify_result")]
