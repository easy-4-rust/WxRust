//! 对应 Java `com.github.binarywang.wxpay.bean.mipay.MedInsOrdersResult.java`。
//!
...
pub struct MedInsOrdersResult {
    ...
    #[serde(default, rename = "mix_pay_status")]
    pub mix_pay_status: String,
    #[serde(default, rename = "self_pay_status")]
    pub self_pay_status: String,
    #[serde(default, rename = "med_ins_pay_status")]
    pub med_ins_pay_status: String,
