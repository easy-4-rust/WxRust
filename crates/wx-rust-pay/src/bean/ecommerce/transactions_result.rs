//! 对应 Java `com.github.binarywang.wxpay.bean.ecommerce.TransactionsResult.java`。
//!
//! 电商收付通交易结果（查询订单接口返回）。
...
pub struct TransactionsResult {
    ...
    pub promotion_detail: Vec<TransactionPromotionDetail>,
}
