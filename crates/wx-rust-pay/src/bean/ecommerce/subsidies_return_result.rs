//! 对应 Java `com.github.binarywang.wxpay.bean.ecommerce.SubsidiesReturnResult.java`。
//!
...
pub struct SubsidiesReturnResult {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "subsidy_refund_id"
    )]
    pub subsidy_refund_id: Option<String>,
