//! 对应 Java `com.github.binarywang.wxpay.bean.profitsharing.result.ProfitSharingReceiverResult.java`。
//!
...
impl ProfitSharingReceiverResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("ProfitSharingReceiverResult 序列化失败: {e}"))?;
