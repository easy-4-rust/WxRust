//! 对应 Java `com.github.binarywang.wxpay.bean.profitsharing.result.ProfitSharingReturnResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct ProfitSharingReturnResult {
    #[serde(
        default,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "error_msg")]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "return_account_type"
    )]
    pub return_account_type: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "return_account"
    )]
    pub return_account: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
impl ProfitSharingReturnResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("ProfitSharingReturnResult 序列化失败: {e}"))?;
