//! 对应 Java `com.github.binarywang.wxpay.bean.profitsharing.result.ProfitSharingResult.java`。
//!
...
pub struct ProfitSharingResult {
    ...
    #[serde(default, rename = "receiverList")]
    pub receiver_list: Vec<Receiver>,
}
...
impl ProfitSharingResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("ProfitSharingResult 序列化失败: {e}"))?;
