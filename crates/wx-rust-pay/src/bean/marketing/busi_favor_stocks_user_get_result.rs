//! 对应 Java `com.github.binarywang.wxpay.bean.marketing.BusiFavorStocksUserGetResult.java`。
//!
...
pub struct BusiFavorStocksUserGetResult {
    #[serde(
        default,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "send_count_information"
    )]
    pub send_count_information: Option<SendCountInformation>,
}

#[derive(Debug, Clone, Default, PartialEq, serde::Serialize, serde::Deserialize)]
pub struct SendCountInformation {
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "total_send_num"
    )]
    pub total_send_num: Option<i32>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "total_send_amount"
    )]
    pub total_send_amount: Option<i32>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "today_send_num"
    )]
    pub today_send_num: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "today_send_amount"
    )]
    pub today_send_amount: Option<String>,
}
