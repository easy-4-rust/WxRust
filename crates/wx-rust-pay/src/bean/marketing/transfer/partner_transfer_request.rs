//! 对应 Java `com.github.binarywang.wxpay.bean.marketing.transfer.PartnerTransferRequest.java`。
//!
...
pub struct PartnerTransferRequest {
...
pub struct TransferDetail {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "transfer_purpose"
    )]
    pub transfer_purpose: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "transfer_scene"
    )]
    pub transfer_scene: Option<String>,
}
