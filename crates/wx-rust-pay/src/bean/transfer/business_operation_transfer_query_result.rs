//! 对应 Java `com.github.binarywang.wxpay.bean.transfer.BusinessOperationTransferQueryResult.java`。
//!
...
pub struct BusinessOperationTransferQueryResult {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "operation_scene_id"
    )]
    pub operation_scene_id: Option<String>,
