//! 对应 Java `com.github.binarywang.wxpay.bean.transfer.TransferBillsRequest.java`。
//!
...
pub struct TransferBillsRequest {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "receipt_authorization_mode"
    )]
    pub receipt_authorization_mode: Option<String>,
}
