//! 对应 Java `com.github.binarywang.wxpay.bean.payscore.WxPartnerPayScoreResult.java`。
//!
...
pub struct WxPartnerPayScoreResult {
...
impl WxPartnerPayScoreResult {
    /// 从 JSON 构建（对应 Java `fromJson`）。
    pub fn from_json(json: &str) -> Result<Self, String> {
        serde_json::from_str(json).map_err(|e| format!("WxPartnerPayScoreResult 解析失败: {e}"))
    }
}
