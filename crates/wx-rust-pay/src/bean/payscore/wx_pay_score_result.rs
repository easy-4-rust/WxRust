//! 对应 Java `com.github.binarywang.wxpay.bean.payscore.WxPayScoreResult.java`。
//!
...
pub struct Collection {
    ...
    #[serde(default, rename = "paying_amount")]
    pub paying_amount: i32,
    #[serde(default, rename = "paid_amount")]
    pub paid_amount: i32,
    #[serde(default, rename = "details")]
    pub details: Vec<Detail>,
}

impl WxPayScoreResult {
    /// 从 JSON 构建（对应 Java `fromJson`）。
    pub fn from_json(json: &str) -> Result<Self, String> {
        serde_json::from_str(json).map_err(|e| format!("WxPayScoreResult 解析失败: {e}"))
    }
}
