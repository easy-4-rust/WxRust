//! 对应 Java `com.github.binarywang.wxpay.bean.payscore.PartnerUserSignPlanDetail.java`。
//!
...
pub struct PartnerUserSignPlanDetail {
    #[serde(
        default,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "plan_detail_state"
    )]
    pub plan_detail_state: Option<String>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "actual_pay_price"
    )]
    pub actual_pay_price: Option<i32>,
