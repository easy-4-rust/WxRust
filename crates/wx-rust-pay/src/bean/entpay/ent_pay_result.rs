//! 对应 Java `com.github.binarywang.wxpay.bean.entpay.EntPayResult.java`。
//!
...
pub struct EntPayResult {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mch_appid")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "retcode")]
...
impl EntPayResult {
    ...
    pub fn from_xml(xml: &str) -> Result<Self, String> {
        let mut v: Self =
            quick_xml::de::from_str(xml).map_err(|e| format!("EntPayResult 解析失败: {e}"))?;
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out =
            quick_xml::se::to_string(self).map_err(|e| format!("EntPayResult 序列化失败: {e}"))?;
