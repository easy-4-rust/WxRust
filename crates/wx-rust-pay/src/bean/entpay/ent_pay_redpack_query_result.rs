//! 对应 Java `com.github.binarywang.wxpay.bean.entpay.EntPayRedpackQueryResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct EntPayRedpackQueryResult {
    #[serde(
        default,
...
impl EntPayRedpackQueryResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("EntPayRedpackQueryResult 序列化失败: {e}"))?;
