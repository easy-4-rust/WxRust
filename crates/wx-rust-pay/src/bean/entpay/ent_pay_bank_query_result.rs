//! 对应 Java `com.github.binarywang.wxpay.bean.entpay.EntPayBankQueryResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct EntPayBankQueryResult {
    #[serde(
        default,
    ...
    pub bank_no_md5: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "true_name_md5"
    )]
    pub true_name_md5: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cmms_amt")]
    pub cmms_amount: Option<i32>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "create_time"
...
impl EntPayBankQueryResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("EntPayBankQueryResult 序列化失败: {e}"))?;
