//! 对应 Java `com.github.binarywang.wxpay.bean.entpay.EntPayRedpackResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct EntPayRedpackResult {
    #[serde(
        default,
...
impl EntPayRedpackResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("EntPayRedpackResult 序列化失败: {e}"))?;
