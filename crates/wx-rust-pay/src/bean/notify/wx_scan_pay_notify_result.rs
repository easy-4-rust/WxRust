//! 对应 Java `com.github.binarywang.wxpay.bean.notify.WxScanPayNotifyResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxScanPayNotifyResult {
    #[serde(
        default,
...
impl WxScanPayNotifyResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxScanPayNotifyResult 序列化失败: {e}"))?;
