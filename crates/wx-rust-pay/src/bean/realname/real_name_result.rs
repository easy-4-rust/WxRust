//! 对应 Java `com.github.binarywang.wxpay.bean.realname.RealNameResult.java`。
//!
...
pub struct RealNameResult {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cert_info")]
    pub cert_info: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "guide_url")]
...
impl RealNameResult {
    ...
    pub fn from_xml(xml: &str) -> Result<Self, String> {
        let mut v: Self =
            quick_xml::de::from_str(xml).map_err(|e| format!("RealNameResult 解析失败: {e}"))?;
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("RealNameResult 序列化失败: {e}"))?;
