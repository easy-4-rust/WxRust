//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxPayFacepayResult.java`。
//!
...
pub struct WxPayFacepayResult {
    ...
    pub subs_subscribe: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "trade_type"
...
impl WxPayFacepayResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxPayFacepayResult 序列化失败: {e}"))?;
