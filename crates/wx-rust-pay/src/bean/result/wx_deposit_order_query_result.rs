//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxDepositOrderQueryResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxDepositOrderQueryResult {
    #[serde(
        default,
...
impl WxDepositOrderQueryResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxDepositOrderQueryResult 序列化失败: {e}"))?;
