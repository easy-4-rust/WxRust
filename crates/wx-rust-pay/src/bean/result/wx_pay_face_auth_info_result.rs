//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxPayFaceAuthInfoResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxPayFaceAuthInfoResult {
    #[serde(
        default,
...
impl WxPayFaceAuthInfoResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxPayFaceAuthInfoResult 序列化失败: {e}"))?;
