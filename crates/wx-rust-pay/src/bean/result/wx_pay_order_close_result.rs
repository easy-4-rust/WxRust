//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxPayOrderCloseResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxPayOrderCloseResult {
    #[serde(
        default,
...
impl WxPayOrderCloseResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxPayOrderCloseResult 序列化失败: {e}"))?;
