//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxPaySandboxSignKeyResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxPaySandboxSignKeyResult {
    #[serde(
        default,
...
impl WxPaySandboxSignKeyResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxPaySandboxSignKeyResult 序列化失败: {e}"))?;
