//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxPayAuthcode2OpenidResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxPayAuthcode2OpenidResult {
    #[serde(
        default,
...
impl WxPayAuthcode2OpenidResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxPayAuthcode2OpenidResult 序列化失败: {e}"))?;
