//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxPayMicropayResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxPayMicropayResult {
    #[serde(
        default,
...
impl WxPayMicropayResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxPayMicropayResult 序列化失败: {e}"))?;
