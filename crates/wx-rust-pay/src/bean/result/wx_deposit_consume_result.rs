//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxDepositConsumeResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxDepositConsumeResult {
    #[serde(
        default,
...
impl WxDepositConsumeResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxDepositConsumeResult 序列化失败: {e}"))?;
