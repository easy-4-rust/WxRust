//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxDepositUnfreezeResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxDepositUnfreezeResult {
    #[serde(
        default,
...
impl WxDepositUnfreezeResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxDepositUnfreezeResult 序列化失败: {e}"))?;
