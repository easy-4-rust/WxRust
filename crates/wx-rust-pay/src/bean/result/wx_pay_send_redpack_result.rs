//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxPaySendRedpackResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxPaySendRedpackResult {
    #[serde(
        default,
...
impl WxPaySendRedpackResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxPaySendRedpackResult 序列化失败: {e}"))?;
