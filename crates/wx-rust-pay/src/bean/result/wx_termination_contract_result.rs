//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxTerminationContractResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxTerminationContractResult {
    #[serde(
        default,
...
impl WxTerminationContractResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxTerminationContractResult 序列化失败: {e}"))?;
