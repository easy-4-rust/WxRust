//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxPayEntrustResult.java`。
//!
...
pub struct WxPayEntrustResult {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "contract_result_code"
    )]
    pub contract_result_code: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "contract_err_code"
    )]
    pub contract_err_code: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "contract_err_code_des"
    )]
    pub contract_err_code_des: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mweb_url")]
...
impl WxPayEntrustResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxPayEntrustResult 序列化失败: {e}"))?;
