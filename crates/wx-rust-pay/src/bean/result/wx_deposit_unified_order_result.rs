//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxDepositUnifiedOrderResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxDepositUnifiedOrderResult {
    #[serde(
        default,
...
impl WxDepositUnifiedOrderResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxDepositUnifiedOrderResult 序列化失败: {e}"))?;
