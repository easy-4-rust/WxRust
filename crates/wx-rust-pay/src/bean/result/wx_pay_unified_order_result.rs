//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxPayUnifiedOrderResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxPayUnifiedOrderResult {
    #[serde(
        default,
...
impl WxPayUnifiedOrderResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxPayUnifiedOrderResult 序列化失败: {e}"))?;
