//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxPaySendMiniProgramRedpackResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxPaySendMiniProgramRedpackResult {
    #[serde(
        default,
...
impl WxPaySendMiniProgramRedpackResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxPaySendMiniProgramRedpackResult 序列化失败: {e}"))?;
