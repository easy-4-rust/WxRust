//! 对应 Java `com.github.binarywang.wxpay.bean.result.WxDepositRefundResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxDepositRefundResult {
    #[serde(
        default,
...
impl WxDepositRefundResult {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxDepositRefundResult 序列化失败: {e}"))?;
