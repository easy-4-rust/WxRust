//! 对应 Java `com.github.binarywang.wxpay.bean.request.WxMpEntrustRequest.java`。
//!
...
impl WxMpEntrustRequest {
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxMpEntrustRequest 序列化失败: {e}"))?;
