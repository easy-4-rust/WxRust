//! 对应 Java `com.github.binarywang.wxpay.bean.request.WxPayUnifiedOrderV3Request.java`。
//!
...
pub struct WxPayUnifiedOrderV3Request {
...
pub struct Payer {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "identity")]
...
pub struct Identity {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    pub r#type: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "number")]
