//! 对应 Java `com.github.binarywang.wxpay.bean.request.WxPreWithholdRequest.java`。
//!
...
pub struct WxPreWithholdRequest {
    ...
    #[serde(
        ...
        rename = "estimated_amount"
    )]
    pub estimate_amount: Option<EstimateAmount>,
}

#[derive(Debug, Clone, Default, PartialEq, serde::Serialize, serde::Deserialize)]
pub struct EstimateAmount {
