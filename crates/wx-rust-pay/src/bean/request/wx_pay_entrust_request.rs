//! 对应 Java `com.github.binarywang.wxpay.bean.request.WxPayEntrustRequest.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxPayEntrustRequest {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "contract_mchid"
    )]
    pub contract_mch_id: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "contract_appid"
    )]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "limit_pay")]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "contract_display_account"
    )]
    pub contract_display_account: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "contract_notify_url"
    )]
    pub contract_notify_url: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "contract_outerid"
    )]
    pub contract_outer_id: Option<String>,
}

impl WxPayEntrustRequest {
    /// 从 XML 解析（对应 Java `fromXML`，XStream 语义：未知元素忽略、缺失字段默认）。
    pub fn from_xml(xml: &str) -> Result<Self, String> {
        quick_xml::de::from_str(xml).map_err(|e| format!("WxPayEntrustRequest 解析失败: {e}"))
    }
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxPayEntrustRequest 序列化失败: {e}"))?;
