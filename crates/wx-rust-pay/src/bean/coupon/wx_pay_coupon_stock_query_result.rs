//! 对应 Java `com.github.binarywang.wxpay.bean.coupon.WxPayCouponStockQueryResult.java`。
//!
...
#[serde(rename = "xml")]
pub struct WxPayCouponStockQueryResult {
    #[serde(
        default,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "coupon_mininumn"
    )]
    pub coupon_minimum: Option<i32>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "coupon_stock_status"
    )]
    pub coupon_stock_status: Option<i32>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "coupon_total"
    )]
    pub coupon_total: Option<i32>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "max_quota")]
    pub max_quota: Option<i32>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "is_send_num"
    )]
    pub is_send_num: Option<i32>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "begin_time"
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "coupon_budget"
    )]
    pub coupon_budget: Option<i32>,
}

impl WxPayCouponStockQueryResult {
    /// 从 XML 解析（对应 Java `fromXML`，XStream 语义：未知元素忽略、缺失字段默认）。
    pub fn from_xml(xml: &str) -> Result<Self, String> {
        let mut v: Self = quick_xml::de::from_str(xml)
            .map_err(|e| format!("WxPayCouponStockQueryResult 解析失败: {e}"))?;
    ...
    pub fn to_xml(&self) -> Result<String, String> {
        let out = quick_xml::se::to_string(self)
            .map_err(|e| format!("WxPayCouponStockQueryResult 序列化失败: {e}"))?;
