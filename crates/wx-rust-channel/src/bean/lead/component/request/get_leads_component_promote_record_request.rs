//! 对应 Java `me.chanjar.weixin.channel.bean.lead.component.request.GetLeadsComponentPromoteRecordRequest.java`。
//!
...
pub struct GetLeadsComponentPromoteRecordRequest {
