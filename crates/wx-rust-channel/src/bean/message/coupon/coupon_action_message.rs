//! 卡券操作 消息。
//!
//! 对应 Java `me.chanjar.weixin.channel.bean.message.coupon.CouponActionMessage.java`
//! （继承 `WxChannelMessage`）。

use serde::{Deserialize, Serialize};

use crate::bean::message::coupon::CouponActionInfo;

/// 卡券操作 消息（对应 Java `CouponActionMessage`）。
#[derive(Debug, Clone, Default, PartialEq, Serialize, Deserialize)]
pub struct CouponActionMessage {
    ...
    pub coupon_info: Option<CouponActionInfo>,
}
