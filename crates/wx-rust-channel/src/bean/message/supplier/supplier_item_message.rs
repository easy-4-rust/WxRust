//! 团长商品变更 消息。
//!
//! 对应 Java `me.chanjar.weixin.channel.bean.message.supplier.SupplierItemMessage.java`
//! （继承 `WxChannelMessage`）。

use serde::{Deserialize, Serialize};

use crate::bean::message::supplier::SupplierItemInfo;

/// 团长商品变更 消息（对应 Java `SupplierItemMessage`）。
#[derive(Debug, Clone, Default, PartialEq, Serialize, Deserialize)]
pub struct SupplierItemMessage {
    ...
    /// 商品变更信息（对应 Java `itemInfo`）。
    #[serde(rename = "item_info", default)]
    pub item_info: Option<SupplierItemInfo>,
}
