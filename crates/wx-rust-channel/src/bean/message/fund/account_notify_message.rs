//! 账户变更通知 消息。
//!
//! 对应 Java `me.chanjar.weixin.channel.bean.message.fund.AccountNotifyMessage.java`
//! （继承 `WxChannelMessage`）。

use serde::{Deserialize, Serialize};

use crate::bean::message::fund::BankNotifyInfo;

/// 账户变更通知 消息（对应 Java `AccountNotifyMessage`）。
#[derive(Debug, Clone, Default, PartialEq, Serialize, Deserialize)]
pub struct AccountNotifyMessage {
    ...
    /// 账户信息（对应 Java `accountInfo`）。
    #[serde(rename = "account_info", default)]
    pub account_info: Option<BankNotifyInfo>,
}
