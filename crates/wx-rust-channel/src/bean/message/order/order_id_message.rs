//! 订单id消息。
//!
//! 对应 Java `me.chanjar.weixin.channel.bean.message.order.OrderIdMessage.java`
//! （继承 `WxChannelMessage`）。

use serde::{Deserialize, Serialize};

use crate::bean::message::order::OrderIdInfo;

/// 订单id消息（对应 Java `OrderIdMessage`）。
...
pub struct OrderIdMessage {
    ...
    pub order_info: Option<OrderIdInfo>,
}
