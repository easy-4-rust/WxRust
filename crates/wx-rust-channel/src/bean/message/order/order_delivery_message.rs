//! 订单发货消息。
//!
//! 对应 Java `me.chanjar.weixin.channel.bean.message.order.OrderDeliveryMessage.java`
//! （继承 `WxChannelMessage`）。

use serde::{Deserialize, Serialize};

use crate::bean::message::order::OrderDeliveryInfo;

/// 订单发货消息（对应 Java `OrderDeliveryMessage`）。
#[derive(Debug, Clone, Default, PartialEq, Serialize, Deserialize)]
pub struct OrderDeliveryMessage {
    ...
    pub order_info: Option<OrderDeliveryInfo>,
}
