//! 订单支付成功消息。
//!
//! 对应 Java `me.chanjar.weixin.channel.bean.message.order.OrderPayMessage.java`
//! （继承 `WxChannelMessage`）。

use serde::{Deserialize, Serialize};

use crate::bean::message::order::OrderPayInfo;

/// 订单支付成功消息（对应 Java `OrderPayMessage`）。
#[derive(Debug, Clone, Default, PartialEq, Serialize, Deserialize)]
pub struct OrderPayMessage {
    ...
    pub order_info: Option<OrderPayInfo>,
}
