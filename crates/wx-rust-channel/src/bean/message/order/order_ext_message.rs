//! 订单其他信息更新 消息。
//!
//! 对应 Java `me.chanjar.weixin.channel.bean.message.order.OrderExtMessage.java`
//! （继承 `WxChannelMessage`）。

use serde::{Deserialize, Serialize};

use crate::bean::message::order::OrderExtInfo;

/// 订单其他信息更新 消息（对应 Java `OrderExtMessage`）。
#[derive(Debug, Clone, Default, PartialEq, Serialize, Deserialize)]
pub struct OrderExtMessage {
    ...
    pub order_info: Option<OrderExtInfo>,
}
