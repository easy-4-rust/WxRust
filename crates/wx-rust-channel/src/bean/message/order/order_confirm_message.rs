//! 订单确认收货消息。
//!
//! 对应 Java `me.chanjar.weixin.channel.bean.message.order.OrderConfirmMessage.java`
//! （继承 `WxChannelMessage`）。

use serde::{Deserialize, Serialize};

use crate::bean::message::order::OrderConfirmInfo;

/// 订单确认收货消息（对应 Java `OrderConfirmMessage`）。
...
pub struct OrderConfirmMessage {
    ...
    pub order_info: Option<OrderConfirmInfo>,
}
