//! 积分兑换消息。
//!
//! 对应 Java `me.chanjar.weixin.channel.bean.message.vip.ExchangeInfoMessage.java`
//! （继承 `WxChannelMessage`）。

use serde::{Deserialize, Serialize};

use crate::bean::message::vip::ExchangeInfo;

/// 积分兑换消息（对应 Java `ExchangeInfoMessage`）。
#[derive(Debug, Clone, Default, PartialEq, Serialize, Deserialize)]
pub struct ExchangeInfoMessage {
    ...
    #[serde(rename = "exchange_info", default)]
