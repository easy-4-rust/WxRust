//! 对应 Java `me.chanjar.weixin.cp.bean.WxCpTpAuthInfo.java`。
//!
...
pub struct AuthInfo {
    ...
    pub agents: Vec<crate::bean::wx_cp_tp_auth_info::Agent>,
}
...
pub struct Agent {
    ...
    pub privilege: crate::bean::wx_cp_tp_auth_info::Privilege,
...
impl WxCpTpAuthInfo {
    ...
    pub fn from_json(json: &str) -> Result<Self, String> {
        serde_json::from_str(json).map_err(|e| format!("WxCpTpAuthInfo 解析失败: {e}"))
    }
}
...
impl WxCpTpAuthInfo {
    ...
    pub fn to_json(&self) -> Result<String, String> {
        serde_json::to_string(self).map_err(|e| format!("WxCpTpAuthInfo 序列化失败: {e}"))
    }
}
