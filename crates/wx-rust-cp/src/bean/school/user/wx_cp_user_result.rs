//! 对应 Java `me.chanjar.weixin.cp.bean.school.user.WxCpUserResult.java`。
//!
...
pub struct Parent {
    ...
    pub children: Vec<crate::bean::school::user::wx_cp_user_result::Children>,
}
...
pub struct Student {
    ...
    pub parents: Vec<crate::bean::school::user::wx_cp_user_result::Parent>,
...
impl WxCpUserResult {
    ...
    pub fn from_json(json: &str) -> Result<Self, String> {
        serde_json::from_str(json).map_err(|e| format!("WxCpUserResult 解析失败: {e}"))
    }
}
...
impl WxCpUserResult {
    ...
    pub fn to_json(&self) -> Result<String, String> {
        serde_json::to_string(self).map_err(|e| format!("WxCpUserResult 序列化失败: {e}"))
    }
}
