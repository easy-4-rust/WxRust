//! 对应 Java `me.chanjar.weixin.cp.bean.oa.wedrive.WxCpFileMove.java`。
//!
...
pub struct FileList {
    ...
    pub item: Vec<crate::bean::oa::wedrive::wx_cp_file_move::Item>,
}
...
impl WxCpFileMove {
    ...
    pub fn from_json(json: &str) -> Result<Self, String> {
        serde_json::from_str(json).map_err(|e| format!("WxCpFileMove 解析失败: {e}"))
    }
}
...
impl WxCpFileMove {
    ...
    pub fn to_json(&self) -> Result<String, String> {
        serde_json::to_string(self).map_err(|e| format!("WxCpFileMove 序列化失败: {e}"))
    }
}
