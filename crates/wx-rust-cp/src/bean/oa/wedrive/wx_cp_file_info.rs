//! 对应 Java `me.chanjar.weixin.cp.bean.oa.wedrive.WxCpFileInfo.java`。
//!
...
pub struct WxCpFileInfo {
    #[serde(rename = "errcode", default)]
    pub errcode: i64,
    #[serde(rename = "errmsg", default)]
    pub errmsg: String,
    #[serde(rename = "file_info", default)]
...
impl WxCpFileInfo {
    ...
    pub fn from_json(json: &str) -> Result<Self, String> {
        serde_json::from_str(json).map_err(|e| format!("WxCpFileInfo 解析失败: {e}"))
    }
}
...
impl WxCpFileInfo {
    ...
    pub fn to_json(&self) -> Result<String, String> {
        serde_json::to_string(self).map_err(|e| format!("WxCpFileInfo 序列化失败: {e}"))
    }
}
