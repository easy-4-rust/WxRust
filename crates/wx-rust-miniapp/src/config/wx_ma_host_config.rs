//! 小程序 API 域名配置。
//!
//! 对应 Java `me.chanjar.weixin.mp.config.WxMpHostConfig` 的移植
//! （Java 小程序侧以 `WxMaConfig.getApiHostUrl()`/`getEffectiveApiHostUrl()`
//! 表达同一语义，Rust 统一为 host config 结构）。
