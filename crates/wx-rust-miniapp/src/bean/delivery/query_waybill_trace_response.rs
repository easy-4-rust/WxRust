//! 对应 Java `cn.binarywang.wx.miniapp.bean.delivery.QueryWaybillTraceResponse.java`。
//!
...
pub struct QueryWaybillTraceResponse {
...
impl QueryWaybillTraceResponse {
    /// 从 JSON 构建（对应 Java `fromJson`）。
    pub fn from_json(json: &str) -> Result<Self, String> {
        serde_json::from_str(json).map_err(|e| format!("QueryWaybillTraceResponse 解析失败: {e}"))
    }
}
