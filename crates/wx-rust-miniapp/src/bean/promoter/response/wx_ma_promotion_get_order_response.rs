//! 对应 Java `cn.binarywang.wx.miniapp.bean.promoter.response.WxMaPromotionGetOrderResponse.java`。
//!
...
pub struct WxMaPromotionGetOrderResponse {
...
pub struct Order {
    ...
    pub paid_time: i64,
    #[serde(rename = "refunded_time", default)]
    pub refunded_time: i64,
}
