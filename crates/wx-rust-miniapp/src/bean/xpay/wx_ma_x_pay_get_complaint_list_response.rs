//! 对应 Java `cn.binarywang.wx.miniapp.bean.xpay.WxMaXPayGetComplaintListResponse.java`。
//!
...
pub struct WxMaXPayGetComplaintListResponse {
    ...
    pub total: i32,
    #[serde(rename = "complaints", default)]
...
impl WxMaXPayGetComplaintListResponse {
    /// 序列化为 JSON（对应 Java `toJson`）。
    pub fn to_json(&self) -> Result<String, String> {
        serde_json::to_string(self)
            .map_err(|e| format!("WxMaXPayGetComplaintListResponse 序列化失败: {e}"))
    }
}
